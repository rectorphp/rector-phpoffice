...
return static function (RectorConfig $rectorConfig): void {
    $rectorConfig->rules([
        ChangeIOFactoryArgumentRector::class,
        ChangeSearchLocationToRegisterReaderRector::class,
        CellStaticToCoordinateRector::class,
        ChangeDataTypeForValueRector::class,
        ChangePdfWriterRector::class,
        ChangeChartRendererRector::class,
        AddRemovedDefaultValuesRector::class,
        ChangeConditionalReturnedCellRector::class,
        ChangeConditionalGetConditionRector::class,
        ChangeConditionalSetConditionRector::class,
        RemoveSetTempDirOnExcelWriterRector::class,
        ChangeDuplicateStyleArrayToApplyFromArrayRector::class,
        GetDefaultStyleToGetParentRector::class,
        IncreaseColumnIndexRector::class,
    ]);
